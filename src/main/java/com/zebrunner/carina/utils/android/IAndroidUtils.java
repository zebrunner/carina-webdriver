...
public interface IAndroidUtils extends IMobileUtils {
     ...
     * @throws UnsupportedOperationException if driver does not support this feature
     */
    default void pressKeyboardKeys(List<AndroidKey> keys) {
        PressesKey driver;
        try {
            driver = (PressesKey) getDriver();
        } catch (ClassCastException e) {
     ...
     * @see <a href="https://github.com/appium/appium-uiautomator2-driver#platform-specific-extensions">Platform-specific extensions</a>
     */
    default String executeShell(List<String> commands) {
    ...
    default List<String> getAppPermissions(String appPackage, PermissionType type) {
    ...
    default void openAppMenuFromDeviceSettings(String appName) {
        ...
        ExtendedWebElement appItem = AbstractUIObject.Builder.getInstance()
                ...
                .setDescriptionName("notifications")
                .setDriver(getDriver())
                .setSearchContext(getDriver())
                .build(ExtendedWebElement.class);
        swipe(appItem);
